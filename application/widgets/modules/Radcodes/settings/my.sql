...
('radcodes', 'Radcodes Core Library', 'This module is Radcodes Core Library, and is required by all SocialEngine Modules developed by Radcodes.', '4.1.1', 1, 'extra');
...
--
DELETE FROM `engine4_core_tasks` WHERE module = 'radcodes';

INSERT IGNORE INTO `engine4_core_tasks` (`title`, `module`, `plugin`, `timeout`) VALUES
('Optimize Database Tables', 'radcodes', 'Radcodes_Plugin_Task_Optimize', 604800);
