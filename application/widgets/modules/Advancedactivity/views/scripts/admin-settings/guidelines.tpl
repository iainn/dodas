...
<div class='clear'>
  <a href="<?php echo $this->url(array('module' => 'advancedactivity', 'controller' => 'settings'), 'admin_default', true) ?>" class="buttonlink" style="background-image:url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Seaocore/externals/images/back.png);padding-left:23px;"><?php echo $this->translate("Back to Global Settings"); ?></a>
