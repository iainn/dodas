...
<div class="seaocore_popup">
	<div class="seaocore_popup_top">
		<div class="seaocore_popup_des"><b><?php echo  $this->translate("Edit your list for viewing updates by choosing content items and friends below.") ?></b></div>
	</div>
	...
	<div class="popup_btm">
		...
		<form method="post" action="" id="form_custom_list">
			...
			<div class="aaf_feed_popup_bottom">
				<button type='button' onClick='submitListForm()'><?php echo sprintf($this->translate('Edit list with %s items'),'<span id="item_count">0</span>'); ?> </span></button>
