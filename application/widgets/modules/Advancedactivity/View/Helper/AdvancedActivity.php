 ...
 * @version    $Id: AdvancedActivity.php 6590 2012-26-01 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Advancedactivity_View_Helper_AdvancedActivity extends Zend_View_Helper_Abstract {

  public function advancedActivity(Activity_Model_Action $action = null, array $data = array(), $method = null, $show_all_comments = false) {
    if (null === $action) {
      return '';
    }
    ...
    if ($method == 'update') {
      return $this->view->partial(
                      '_activityComments.tpl', 'advancedactivity', $data
      );
    } else {
      return $this->view->partial(
                      '_activityText.tpl', 'advancedactivity', $data
      );
    }
  }
