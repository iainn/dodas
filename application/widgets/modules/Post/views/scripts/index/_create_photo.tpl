...
en4.core.runonce.add(function() {
  ...
  $('post_create_photo_toggle_upload').addEvent('click', function(event){
    $('url-wrapper').hide();
    $('photo-wrapper').show();     
	});
  $('post_create_photo_toggle_add').addEvent('click', function(event){
	  $('url-wrapper').show();
	  $('photo-wrapper').hide();    
    $('photo').set('value', ''); 
	});
  ...
  new OverText($('url'), {'textOverride':'Paste a link to your photo here','element':'span'});
