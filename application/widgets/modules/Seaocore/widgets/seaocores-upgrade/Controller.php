...
//     }
    ...
    foreach( $rss as $item )
    {
      ...
      if( strstr($plugin_info['ptype'], 'sitereviewlistingtype') ) {
        $plugin_info['title'] = 'Reviews & Ratings - Multiple Listing Types Extension';
        $plugin_info['ptype'] = 'sitereviewlistingtype';
        $plugin_info['key'] = Engine_Api::_()->getApi('settings', 'core')->getSetting('sitereviewlistingtype.lsettings');        
        $plugin_info['running_version'] = Engine_Api::_()->getDbtable('modules', 'core')->getModule('sitereviewlistingtype')->version;
        $plugin_info['name'] = 'sitereviewlistingtype';
      }
