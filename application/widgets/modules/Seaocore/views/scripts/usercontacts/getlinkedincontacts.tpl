...
if ($total > 0) { ?>
		...
		<?php else : ?>	
			 ...
			 <div class="title">	
				<?php echo $this->translate("Found %s Linkedin contacts you can promote this Page to.", $total);?>
			</div>
			<div>
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				<?php
				  ...
				  foreach($this->addtononfriend as $values) {
					...
					<tr>
						<td width="4%">
							<input type="checkbox" name="nonsitecontactname_"<?php echo $total_contacts;?>  id="nonsitecontact_<?php echo $total_contacts;?>" checked="checked" value='<?php echo $values['id'];?>'>
						</td>
						<td width="10%">
