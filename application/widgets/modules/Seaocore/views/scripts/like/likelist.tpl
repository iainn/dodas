...
<script type="text/javascript">
 ...
 var url = en4.core.baseUrl + 'seaocore/like/likelist';// URL where send ajax request.
	function show_myfriend () {
		$('lists_popup_content').innerHTML = '<center><img src="application/modules/list/externals/images/spinner.gif" /></center>';
    ...
    $('like_members_search_input').addEvent('keyup', function(e) {
		$('lists_popup_content').innerHTML = '<center><img src="<?php echo $this->layout()->staticBaseUrl?>application/modules/List/externals/images/spinner.gif" alt="" class="mtop_10" /></center>';
      en4.core.request.send(new Request.HTML({
        'url' : url,
        'data' : {
          'format' : 'html',
