...
($this->subject()->likes()->isLike($this->viewer())): ?>style="display: none;" <?php endif;
?>onclick="en4.seaocore.photolightbox.comments.like('<?php echo $this->subject()->getType() ?>', '<?php
echo $this->subject()->getIdentity() ?>');" href="javascript:void(0);" class="photo_lightbox_like"
...
(!$this->subject()->likes()->isLike($this->viewer())): ?>style="display:none;" <?php endif; ?>
onclick="en4.seaocore.photolightbox.comments.unlike('<?php echo $this->subject()->getType() ?>', '<?php
echo $this->subject()->getIdentity() ?>');" href="javascript:void(0);" class="photo_lightbox_unlike"
title="<?php echo $this->translate('Unlike This'); ?>"><?php echo $this->translate('Unlike'); ?></a>
    <a href="javascript:void(0);" onclick="if($('comment-form-open-li_<?php echo $this->subject()->getType()?>_<?php echo $this->subject()->getIdentity() ?>')){
	      ...
	      $('comment-form_<?php echo $this->subject()->getType()."_".$this->subject()->getIdentity() ?>').style.display = '';$('comment-form_<?php echo $this->subject()->getType()."_".$this->subject()->getIdentity() ?>').body.focus();" class="photo_lightbox_comment" title="<?php echo $this->translate('Post
...
$this->resource_type; ?>').addEvent('complete', function(){ this.set('class',
'icon_photos_lightbox_rotate_ccw') }.bind(this));loadingImageSeaocore(); " title="<?php echo
$this->translate("Rotate Left"); ?>" ></a>
...
$this->resource_type; ?>').addEvent('complete', function(){ this.set('class',
'icon_photos_lightbox_rotate_cw') }.bind(this)); loadingImageSeaocore();" title="<?php echo
$this->translate("Rotate Right"); ?>" ></a>
...
$this->resource_type; ?>').addEvent('complete', function(){ this.set('class',
'icon_photos_lightbox_flip_horizontal') }.bind(this)); loadingImageSeaocore();" title="<?php echo
$this->translate("Flip Horizontal"); ?>" ></a>
...
$this->resource_type; ?>').addEvent('complete', function(){ this.set('class',
'icon_photos_lightbox_flip_vertical') }.bind(this)); loadingImageSeaocore();" title="<?php echo
$this->translate("Flip Vertical"); ?>"></a>
  </div>
<?php endif; ?>
    ...
    <div class="photo_lightbox_content_left">
      ...
      <div class="photo_options">
        ...
        <?php if (!empty($viewer_id)): ?>
          <?php if ($this->module_name != 'sitepagenote' && $this->module_name != 'sitebusinessnote'): ?>
            <?php if ($this->module_name != 'sitepage' && $this->module_name != 'sitebusiness'): ?>
        ...
        <?php if (!empty($viewer_id)): ?>
          <?php if (SEA_PHOTOLIGHTBOX_SHARE): ?>
            <a href="javascript:void(0);" onclick="showSmoothBox('<?php echo $this->escape($this->url(array('module' => 'activity', 'controller' => 'index', 'action' => 'share', 'type' => $this->resource_type, 'id' => $this->photo->getIdentity(), 'format' => 'smoothbox'), 'default', true)); ?>'); return false;" >
