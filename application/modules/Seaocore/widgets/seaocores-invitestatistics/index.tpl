...
<div class='seaocore_invite_left'>
  ...
  <div class="seaocore_invite_right">
  	<div class="seaocore_invite_statistics_header">
		  <select class="invite_types" id="invite_types">
		    <option value="1">My Referrals</option> 
		    <option value="0">Pending Invites</option>
		  </select>
		  ...
		  <select class="invite_types" id="service_types">
		    ...
		    <option value="aol">Aol</option>
		 	...
		 	<select class="invite_types fright last">
		    <option value="all">All</option>
		    <option value="google">Gmail</option>
		  </select>
	  </div>
  ...
  var cal_startdate_onHideStart = function() {
    // check end date and make it the same date if it's too
    cal_endtime.calendars[0].start = new Date( $('startdate-date').value );
    // redraw calendar
  ...
  var cal_endtime_onHideStart = function() {
    ...
    cal_startdate.calendars[0].end = new Date( $('endtime-date').value );
    // redraw calendar
    cal_startdate.navigate(cal_startdate.calendars[0], 'm', 1);
    cal_startdate.navigate(cal_startdate.calendars[0], 'm', -1);
  }
    ...
    var searchMembers = window.searchMembers = function() { 
       $('statistics_info').innerHTML = "<center><img src='application/modules/Seaocore/externals/images/loadings.gif' alt='' /></center>";
