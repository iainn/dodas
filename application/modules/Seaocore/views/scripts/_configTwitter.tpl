			...
			<li>
				<div class="steps">
					...
					<div id="twitterstep-1" style='display: none;'>
						...
						<?php echo $this->translate("Go to this URL for steps to configure basic Twitter Integration on your SocialEngine website : ");?> <a href="http://www.youtube.com/watch?v=m_iInq9udZA&list=UUlUy2ac9Xb-Bw95e1EyKlEQ&index=4&feature=plcp" target="_blank" style="color:#5BA1CD;">http://www.youtube.com/watch?v=m_iInq9udZA&list=UUlUy2ac9Xb-Bw95e1EyKlEQ&index=4&feature=plcp</a><br />			
