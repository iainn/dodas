...
$this->headScript()
        //  ->appendFile(( (!empty($_ENV["HTTPS"]) && 'on' == strtolower($_ENV["HTTPS"])) ? "https://" : "http://" ) . 'maps.google.com/maps/api/js?sensor=false')
        ->appendFile(( (!empty($_ENV["HTTPS"]) && 'on' == strtolower($_ENV["HTTPS"])) ? "https://" : "http://" ) . "maps.googleapis.com/maps/api/js?libraries=places&sensor=true&key=$apiKey")
          ...
          <table>
            ...
            <tr>
              ...
              <td>
	              ...
	              <?php //echo $this->htmlLink('http://maps.google.com/?q=' . urlencode($this->checkin['location']), $this->translate('&nbsp;'), array('target' => '_blank', 'class'=> 'sdf', 'title' => $this->translate('See on Google Map'))) ?>
	            </td>
	<!--			              <td>
	            	<a href="<?php //echo 'http://maps.google.com/?q=' . urlencode($this->checkin['location']); ?>" class="seaocore_map_tip" target="_blank">
