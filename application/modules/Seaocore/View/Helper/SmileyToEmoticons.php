...
class Seaocore_View_Helper_SmileyToEmoticons extends Zend_View_Helper_Abstract {
  ...
  public function smileyToEmoticons($string) {
   ...
   // $string = htmlspecialchars_decode($string);
    ...
    $string = preg_replace("/__([^_]*)__([^_]*)__([^_]*)__/", "<img class=\"emotions_use\"  src=\"application/modules/Seaocore/externals/emoticons/$1\" border=\"0\" alt=\"$2\" title=\"".$translate->translate("$3")." $2\" />", $string);
    return($string);
  }
