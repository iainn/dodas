  ...
  public function getSocialEngineAddOnsCollectibleSql($collectible, $params=array()) {
    ...
    switch ($type) {
      case 'like_count':
        ...
        if ($resourceType == "list_photo" || $resourceType == "recipe_photo" || $resourceType == "sitepagenote_photo" || $resourceType == "sitepage_photo" || $resourceType == "album_photo" || $resourceType == "group_photo" || $resourceType == "event_photo" || $resourceType == "sitebusinessnote_photo" || $resourceType == "sitebusiness_photo") {
          ...
          if ($resourceType == 'sitepage_photo') {
            $select
                    ->where($tableName . '.like_count > ?', 0)
                    ->order($tableName . '.like_count DESC');
          }
          if ($resourceType == 'sitebusiness_photo') {
            $select
                    ->where($tableName . '.like_count > ?', 0)
                    ->order($tableName . '.like_count DESC');
          }
