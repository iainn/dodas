...
<p><?php echo $this->translate('Your members will be asked to provide some information about their posts when creating a new post. Create some post questions that allow them to provide more detailed posts in a way that relates to the theme of your community. To reorder the post questions, click on their names and drag them up or down.'); ?>
</p>
