INSERT IGNORE INTO `engine4_core_modules` (`name`, `title`, `description`, `version`, `enabled`, `type`) VALUES  ('advancedactivity', 'Advanced Activity', 'Advanced Activity', '4.5.0p1', 1, 'extra') ;
