				...
				if( empty($module_auth) ) {
					if( empty($currentmod_info) ) {
						...
						if( empty($_BASE_FILE_NAME) ) {
							$final_url_2 = 'http://' . $core_final_url . 'index.php/seaocore/index/index/type/' . $PRODUCT_TYPE . '/call_from/' . $calling_from . '/plugin_title/' . $PLUGIN_TITLE;

							$final_url_1 = 'http://' . $core_final_url . 'seaocore/index/index/type/' . $PRODUCT_TYPE . '/call_from/' . $calling_from . '/plugin_title/' . $PLUGIN_TITLE;
						}else {
							$final_url_2 = 'http://' . $core_final_url . 'index.php/seaocore/index/index/type/' . $PRODUCT_TYPE . '/call_from/' . $calling_from . '/plugin_title/' . $PLUGIN_TITLE . '/base_file/' . $_BASE_FILE_NAME;

							$final_url_1 = 'http://' . $core_final_url . 'seaocore/index/index/type/' . $PRODUCT_TYPE . '/call_from/' . $calling_from . '/plugin_title/' . $PLUGIN_TITLE . '/base_file/' . $_BASE_FILE_NAME;
						}
